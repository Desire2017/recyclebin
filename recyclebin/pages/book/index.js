...
Page({
  ...
  onLoad(options) {
    ...
    wx.request({
      url: util.apiUrl + 'GetArticleApi.ashx?type=0&id=3',
      success(res) {
    ...
    //获取顶部广告
    wx.request({
      url: util.apiUrl + "GetAdvertApi.ashx?id=6",
      success(res) {
        self.setData({
    ...
    //顶部菜单
    wx.request({
      url: util.apiUrl + "GetBookClassApi.ashx?&type=1",
      success(res) {
        self.setData({
    ...
    wx.request({
      url: util.apiUrl + "GetBookSetApi.ashx",
      success: function (e) {
        self.setData({
          set: e.data.result
        })
  ...
  submit: function (t) {
    ...
    if (images.length == 0) {
      var url = util.apiUrl + "GetRecycleOrderApi.ashx?type=0&uid=" + uid + "&cid=2" + "&aid=" + aid + "&date=" + t.detail.value.date + "&time=" + t.detail.value.time + "&set=" + t.detail.value.clothesSet;

    }
    if (images.length == 1) {
      var url = util.apiUrl + "GetRecycleOrderApi.ashx?type=0&uid=" + uid + "&cid=2" + "&aid=" + aid + "&date=" + t.detail.value.date + "&time=" + t.detail.value.time + "&set=" + t.detail.value.clothesSet + '&image1=' + images[0].imgUrl;
      console.log("image1=" + images[0].imgUrl);
    }
    if (images.length == 2) {
      var url = util.apiUrl + "GetRecycleOrderApi.ashx?type=0&uid=" + uid + "&cid=2" + "&aid=" + aid + "&date=" + t.detail.value.date + "&time=" + t.detail.value.time + "&set=" + t.detail.value.clothesSet + '&image1=' + images[0].imgUrl + '&image2=' + images[1].imgUrl;
